...
as arguments of the \Rfunction{fit\_led} call. The column headings converted
...
\item \Rcode{fits} -- A data frame with background stats for each

\item \Rcode{dye\_fits} -- A data frame with background stats for each 

\item \Rcode{iterated\_fits} -- A data frame with background stats for each

\item \Rcode{iterated\_dye\_fits} -- A data frame with background stats for each
